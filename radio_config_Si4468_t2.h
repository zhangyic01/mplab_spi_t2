...
#define RF_GET_CHIP_STATUS  0x23
#define RF_GET_INT_STATUS   0x20
#define RF_WRITE_TX_FIFO    0x66 // Writes data byte(s) to the TX FIFO.
#define RF_READ_RX_FIFO     0x77 // Reads data byte(s) from the RX FIFO
#define RF_READ_CMD_BUFF    0x44 // CMD used to read CTS and the command response.


// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 4    Rsymb(sps): 10000    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
...
*/
//yic: Example of how property works.
// 0x11 - CMD of set property
// 0x00 - Group ID
// 0x01 - Number of property
// 0x03 - Start ID
// 0x20 - property data
// Refer to API webpage, Search GLOBAL_CONFIG, we can see it says
// Group: 0x0, Index:0x3 which is the Start ID. Also the property only takes 1 byte data, in this case it is 0x20
// Overall, API only has 2 types, COMMAND and PROPERTY. To set property, we need to use SET_PROPERTY command. property is like a parameterized argument
// of a function call, which specifies how many data are in this argument, and what type of this argument is.
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x04, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x08
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x04, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x10, 0x10, 0x00, 0xE8, 0x01, 0xF4
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x01, 0x06, 0x25, 0x00, 0x16, 0x02, 0x02, 0x00, 0x00, 0x12, 0x80, 0x2C
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x09, 0xA5, 0xA0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x6D, 0x6D, 0x00, 0x02, 0xFF, 0xFF, 0x00, 0x2A, 0x0C, 0xA4, 0x23
...
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x02, 0xFF, 0x01, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40
...
*/
#define RF_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x0A, 0x07
...
*/
#define RF_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x16, 0x78, 0x20
